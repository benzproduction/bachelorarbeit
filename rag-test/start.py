...
def main(
    ...
    logger.info(rag_example_args.csv_path)
    ...
    question = rag_example_args.question or "Wie groß ist das Due Diligence Team ?"
...
class RagExampleArguments:
    csv_path: str = field(
        default=str(Path(__file__).parent.parent / "data/clean/csv" / "real_estate_dataset.csv"),
    ...
    output_dir: Optional[str] = field(
        default=str(Path(__file__).parent.parent / "data/rag" ),
