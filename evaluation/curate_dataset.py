...
output_path = cwd + "/evaluation/data/15042023.jsonl"
# read the excel file and only use the cols A and J
df = pd.read_excel(cwd + "/data/eval/20230419_Overview_RE Reports 2023 - Gold Standard.xlsx", sheet_name="Sheet2", usecols="A,J")
