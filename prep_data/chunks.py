# Form: https://github.com/openai/chatgpt-retrieval-plugin
...
def get_document_chunks(
    ...
    for i in range(0, len(all_chunks), EMBEDDINGS_BATCH_SIZE):
        ...
        batch_embeddings = [get_embedding(text_chunk, engine = 'text-embedding-ada-002') for text_chunk in batch_texts]
